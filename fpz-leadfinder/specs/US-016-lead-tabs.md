...
## Datei: src/components/leads/ExportSection.tsx
...
## Datei: src/app/leads/[id]/actions.ts (ergaenzen)

```typescript
// Zusaetzlich zu updateLeadStatus und updateLeadNotes:
...
## Datei: src/app/leads/[id]/page.tsx (komplett ersetzen)
...
## Datei: src/components/leads/LeadDetailActions.tsx
